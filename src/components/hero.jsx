  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        <div className="mb-4 text-sm text-secondary tracking-widest animate-fadeIn">{"> PLAYER ONE"}</div>

        <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fadeIn">
          <span className="text-primary">SHUBHAM</span> <span className="text-foreground">RAMOLIYA</span>
        </h1>
        ...
        <a
          href="#about"
          className="inline-flex items-center text-sm text-muted-foreground hover:text-primary transition-colors animate-bounce"
        >
